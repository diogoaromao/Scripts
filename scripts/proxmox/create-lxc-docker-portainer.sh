...
echo "  4. Setup Cloudflare tunnel for external access"
echo "  5. Configure GitHub repository secrets (required for CI/CD deployment):"
echo "     - DOCKER_USERNAME: Your Docker Hub username"
echo "     - DOCKER_PASSWORD: Your Docker Hub password/token"
echo "     - PORTAINER_URL: Public hostname on cloudflared tunnel (including protocol, excluding port)"
