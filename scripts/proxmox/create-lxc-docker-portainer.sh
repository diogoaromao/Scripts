...
echo "  4. Run the SSH setup script:"
echo "     Local: ./scripts/proxmox/setup-lxc-ssh-deploy.sh -i $CONTAINER_ID"
echo "     GitHub: curl -sSL https://raw.githubusercontent.com/diogoaromao/Scripts/main/scripts/proxmox/setup-lxc-ssh-deploy.sh | bash -s -- -i $CONTAINER_ID"
